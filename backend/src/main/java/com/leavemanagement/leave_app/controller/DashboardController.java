...
public class DashboardController {
    ...
    public Map<String, Object> getDepartmentStats() {
        ...
        List<com.leavemanagement.leave_app.model.Employee> allEmployees = employeeService.getAllActiveEmployees();
        Map<String, String> employeeToDepartment = new HashMap<>();
        
        for (com.leavemanagement.leave_app.model.Employee employee : allEmployees) {
